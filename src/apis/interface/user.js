...
// `memu` 菜单
export const memu = (data) => axios.get('Market/memu1', data) 
// `memu2` 获取账户权限
export const getAccRole = (data) => axios.get('Market/memu2', data) 
// `my_card` 买卖方名片
export const my_card = (data) => axios.get('Market/my_card', data)  
// `change_psw` 修改密码 参数password  passworda
export const change_psw = (data, config) => axios.post('Market/change_psw', data, config) 

// `edit_card` 编辑买卖方名片
export const edit_card = (data, config) => axios.post('Market/edit_card', data, config) 

// my_company 卖家企业信息
export const my_company = (data, config) => axios.post('Market/my_company', data, config) 
// save_company 编辑卖家企业信息 `company`公司名称, `img`logo, `info`介绍, `phone`联系电话, `address`地址, contacts联系人 ewm二维码图片
export const save_company = (data, config) => axios.post('Market/save_company', data, config) 


// `addresss_list` 地址列表 参数p
export const addresss_list = (data) => axios.get('Market/addresss_list', data) 
...
export const regional_list = (data) => axios.get('Market/regional_list', data) 
// `addressDetail` 地区列表  在编辑地址时regional字段需要用到。
export const addressDetail = (data) => axios.get('Market/addressDetail', data) 
...
// 		auto  0 1
export const address_change = (data) => axios.get('Market/address_change', data) 


// `create_order` 生成订单 参数pid_array  address_id
// json格式，每一条记录包含： cid表示旺铺ID，pid商品ID，num表示购买的商品数量
export const create_order = (data) => axios.get('Market/create_order', data) 
...
export const change_order_status4 = (data) => axios.get('Market/change_order_status4', data)
...
export const orderConfirm = (data) => axios.get('Market/orderConfirm', data)  
...
export const order_score = (data) => axios.get('Market/order_score', data) 
// login_role 角色权限
export const login_role = (data) => axios.get('Market/login_role', data) 

// delivery_list 物流公司列表
export const delivery_list = (data) => axios.get('Market/delivery_list', data) 

// service_list 售后列表 参数p
export const service_list = (data) => axios.get('Market/service_list', data) 
// change_service_status 有两个按钮 一个提交换货的新快递单号 参数id售后id，express 快递单号  
// 另一个按钮 结束售后 参数id  什么时候显示按钮，我列表里返回。
export const change_service_status = (data) => axios.get('Market/change_service_status', data)
// warehouse_list  
export const warehouse_list = (data) => axios.get('Market/warehouse_list', data)  
...
// OUT_PAY_APPLY 出金申请 
    ...
    // amount 提现金额(元)
    // memo 备注
export const sinopay = (data, config) => axios.post('Market/sinopay', data, config) 

// pay_info 出金资料 不用参数，返回auth=1有资料，不需要去获取银行等信息，只要填写一个提现金额和备注（备注不必填） =0没资料 那就要获取出金申请所需的所有资料。
export const pay_info = (data) => axios.get('Market/pay_info', data)

// statement_list 结算申请列表 参数p
export const statement_list = (data) => axios.get('Market/statement_list', data)